...
/*   Updated: 2020/09/28 14:27:07 by mery             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
double		**multiply_mat_param(t_param *param)
{
	...
	mat = NULL;
	if (param && param->left && param->right->mat
		&& param->right && param->left->value)
	{
		...
		param->right && param->right->mat)
	{
		...
		mat = multiply_mat(param->left->mat, param->left->mat_len, param->right->mat, param->right->mat_len);
	}
	return (mat);
}
...
double	 	**divide_mat_param(t_param *param)
{
		...
		param->right && param->right->mat)
	{
		mat = param->left->mat;
		mat2 = param->right->mat;
		mat = divide_mat(param->left->mat, param->left->mat_len, param->right->mat, param->right->mat_len);
	}
	return (mat);
}
